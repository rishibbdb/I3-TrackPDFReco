...
from dom_track_eval import get_eval_network_doms_and_track, get_eval_network_doms_and_track_w_charge_w_icetilt, get_eval_network_doms_and_track_w_icetilt
...
eval_network_doms_and_track = get_eval_network_doms_and_track_w_icetilt(eval_network_v, dtype=dtype)
