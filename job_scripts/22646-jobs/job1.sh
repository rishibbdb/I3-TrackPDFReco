...
OUTPUT_DIR_FTR="/mnt/research/IceCube/Gupta-Reco/22646/0000000-0000999-tfrecords/"
...
i3DIR='/mnt/research/IceCube/Gupta-Reco/22646/0000000-0000999/'
...
python $SCRIPT_DIR/convert_i3_ftr_coinc_muonlabel.py --i3dir $i3DIR --dataset-id $DATASET_ID --file-index-start $INDEX_START --file-index-end $INDEX_END --outdir-ftr $OUTPUT_DIR_FTR --file-base $FILE_BASE | tee $OUTPUT_DIR_LOGS/job1log.txt
