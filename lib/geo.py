...
import numpy as np
import pandas as pd
# from lib.tilt import tiltclass
...
# def cherenkov_cylinder_coordinates_w_rho_icetilt(dom_pos, track_pos, track_dir):
#     """
#     dom_pos: 1D jax array with 3 components [x, y, z]
#     track_pos: 1D jax array with 3 components [x, y, z]
#     track_dir: 1D jax array with 3 components [dir_x, dir_y, dir_z]
...
#     tilt_c = tiltclass()
#     tiltcorr_poe = tilt_c.IceLayerTiltJAX(track_pos + (ds-dx) * track_dir)
#     tiltcorr_pod = tilt_c.IceLayerTiltJAX(dom_pos)
#     v_c_z_corr = v_c[2]
#     v_c_z = v_c_z_corr + ((tiltcorr_poe+tiltcorr_pod)/2)
#     # v_c_z = v_c_z_corr + tiltcorr
#     # tiltcorr = tilt_c.IceLayerTiltJAX(v_c)
#     # v_c_z = tiltcorr

#     # print("Geo: tilt_poe, tilt_pod, v_z_corr, diff=", tiltcorr_poe, tiltcorr_pod, v_c_z, ((tiltcorr_poe+tiltcorr_pod)/2) )
...
# # cherenkov_cylinder_coordinates_w_rho_v = jax.jit(jax.vmap(cherenkov_cylinder_coordinates_w_rho, (0, None, None), (0, 0, 0, 0)))
# cherenkov_cylinder_coordinates_w_rho_v_icetilt = jax.jit(jax.vmap(cherenkov_cylinder_coordinates_w_rho_icetilt, (0, None, None), (0, 0, 0, 0)))
# # print(jax.device_get(cherenkov_cylinder_coordinates_w_rho_v_icetilt))
