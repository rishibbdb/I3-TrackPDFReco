...
with open("/mnt/scratch/baburish/TPN-training/final/TPN_God/reco-logs/22645_255epoch_linefit_iterative.csv", "a", newline="") as f:
    writer = csv.writer(f)
    ...
    for i in range(0,len(events_meta)):
        ...
        for sigma in GAUS_CONV_WIDTH:
            ...
            fit_llh = get_fitter(neg_llh, use_multiple_vertex_seeds=False, prescan_time=False)
